interface ObjsModule {

    objectify<S>(arr: string[], val: S): Record<string,S>

    filter<T>(arr: T[], func: (T)=>boolean, ctx?: any): T[]
...
Scoped.define("module:JavaScript", ["module:Objs"], function(Objs: ObjsModule) {
    /**
    ...
    return {
         ...
         */
        isReserved: function(key: string): boolean {
         ...
         */
        isIdentifier: function(key: string): boolean {
         ...
         * @return {boolean} true if identifier
         */
        isProperIdentifier: function(key: string): boolean {
         ...
         */
        removeStrings: function(code: string): string {
         ...
         */
        extractIdentifiers: function(code: string, keepScopes: boolean) {
            let regex = keepScopes ? this.IDENTIFIER_SCOPE_REGEX : this.IDENTIFIER_REGEX;
         ...
         */
        extractFunctionParameterNames: function(func: any): string[] {
