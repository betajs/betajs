...
},_insert:function(a){return this.decode_object(this.__store.insert(this.encode_object(a)))},_remove:function(a){return this.__store.remove(this.encode_value(this._id_key,a))},_get:function(a){return this.decode_object(this.__store.get(this.encode_value(this._id_key,a)))},_update:function(a,b){return this.decode_object(this.__store.update(this.encode_value(this._id_key,a),this.encode_object(b)))},_query_capabilities:function(){return this.__store._query_capabilities()},_query:function(a,b){var c=this,d=this.__store.query(this.encode_object(a),b);return new BetaJS.Iterators.MappedIterator(d,function(a){return c.decode_object(a)})},_ensure_index:function(a){return this.__store.ensure_index(a)}}),BetaJS.Stores.BaseStore.extend("BetaJS.Stores.PassthroughStore",{constructor:function(a,b){this.__store=a,b=b||{},b.id_key=a.id_key(),b.async_read=a.async_read,b.async_write=a.async_write,this._inherited(BetaJS.Stores.PassthroughStore,"constructor",b)},_supports_async_read:function(){return this.__store._supports_async_read()},_supports_async_write:function(){return this.__store._supports_async_read()},_query_capabilities:function(){return this.__store._query_capabilities()},_insert:function(a,b){return this.__store.insert(a,b)},_remove:function(a,b){return this.__store.remove(a,b)},_get:function(a){return this.__store.get(a)},_update:function(a,b,c){return this.__store.update(a,b,c)},_query:function(a,b){return this.__store.query(a,b)},_ensure_index:function(a){return this.__store.ensure_index(a)}}),BetaJS.Stores.PassthroughStore.extend("BetaJS.Stores.WriteQueueStore",{constructor:function(a,b){this._inherited(BetaJS.Stores.WriteQueueStore,"constructor",a,b),b=b||{},this.__update_queue={},this.__revision_id=1,this.__id_to_queue={},this.__combine_updates="combine_updates"in b?b.combine_updates:!0,this.__auto_clear_updates="auto_clear_updates"in b?b.auto_clear_updates:!0,this.__cache={},this.__auto_clear_updates&&this.on("remove",function(a){this.__remove_update(a)},this)},update:function(a,b,c){return this.__insert_update(a,b),c&&c.success&&c.success(a,b,b),b},__remove_update:function(a){this.__id_to_queue[a],delete this.__id_to_queue[a];for(var b in b)delete this.__update_queue[b];delete this.__cache[a]},__insert_update:function(a,b){if(this.__combine_updates&&this.__id_to_queue[a]){var c={};for(var d in this.__id_to_queue[a])c=BetaJS.Objs.extend(c,this.__update_queue[d].data),delete this.__update_queue[d];c=BetaJS.Objs.extend(c,b),this.__id_to_queue[a]={}}this.__id_to_queue[a]=this.__id_to_queue[a]||{},this.__id_to_queue[a][this.__revision_id]=!0,this.__update_queue[this.__revision_id]={id:a,data:b,revision_id:this.__revision_id},this.__cache[a]=BetaJS.Objs.extend(this.__cache[a]||{},b),this.__revision_id++,this.trigger("queue","update",a,b),this.trigger("queue:update",a,b)},flush:function(a,b){if(b||(b=this.__revision_id),this.async_write()){var c=null,d=this;for(var e in this.__update_queue){c=this.__update_queue[e];break}if(c){if(c.revision_id>=b)return;this.__store.update(c.id,c.data,{exception:a.exception,success:function(){delete this.__update_queue[c.revision_id],delete this.__id_to_queue[c.id][c.revision_id],d.flush(a,b)}})}else a&&a.success()}else try{BetaJS.Objs.iter(this.__update_queue,function(a){return a.revision_id>=b?!1:(this.__store.update(a.id,a.data),!0)},this),a&&a.success&&a.success()}catch(f){if(!a||!a.exception)throw f;a.exception(f)}},changed:function(){return!BetaJS.Types.is_empty(this.__update_queue)},get:function(a){var b=this.__store.get(a);return b&&this.__cache[a]?BetaJS.Objs.extend(b,this.__cache[a]):b},query:function(a,b){var c=this;return new BetaJS.Iterators.MappedIterator(this.__store.query(a,b),function(a){return c.__cache[a[c.id_key()]]?BetaJS.Objs.extend(a,c.__cache[a[c.id_key()]]):a})}}),BetaJS.Class.extend("BetaJS.Stores.WriteQueueStoreManager",[BetaJS.Events.EventsMixin,{constructor:function(a){this._inherited(BetaJS.Stores.WriteQueueStoreManager,"constructor"),a=a||{},this.__stores={},this.__changed=!1,this.__min_delay=a.min_delay?a.min_delay:null,this.__max_delay=a.max_delay?a.max_delay:null,(this.__min_delay||this.__max_delay)&&this.on("changed",function(){this.flush()},this,{min_delay:this.__min_delay,max_delay:this.__max_delay})},destroy:function(){this.off(null,null,this),BetaJS.Objs.iter(this.__stores,function(a){this.unregister(a)},this),this._inherited(BetaJS.Stores.WriteQueueStoreManager,"destroy")},__get:function(a){return a},register:function(a){a=this.__get(a),this.__stores[BetaJS.Ids.objectId(a)]=a,a.on("queue:update",function(){this.__changed=!0,this.trigger("changed")},this)},unregister:function(a){a=this.__get(a),delete this.__stores[BetaJS.Ids.objectId(a)],a.off(null,null,this)},flush:function(a){this.trigger("flush_start"),this.trigger("flush");var b=0,c=BetaJS.Objs.count(this.__stores),d=this;BetaJS.Objs.iter(this.__stores,function(e){e.flush({exception:function(b){if(d.trigger("flush_error"),!a||!a.exception)throw b;a.exception(b)},success:function(){b++,b==c&&(d.trigger("flush_end"),a&&a.success&&a.success())}})},this),this.__changed=!1,BetaJS.Objs.iter(this.__stores,function(a){this.__changed=this.__changed||a.changed()},this)}}]),BetaJS.Net=BetaJS.Net||{},BetaJS.Net.HttpHeader={HTTP_STATUS_OK:200,HTTP_STATUS_CREATED:201,HTTP_STATUS_PAYMENT_REQUIRED:402,HTTP_STATUS_FORBIDDEN:403,HTTP_STATUS_NOT_FOUND:404,HTTP_STATUS_PRECONDITION_FAILED:412,HTTP_STATUS_INTERNAL_SERVER_ERROR:500,format:function(a,b){var c="";return c=a==this.HTTP_STATUS_OK?"OK":a==this.HTTP_STATUS_CREATED?"Created":a==this.HTTP_STATUS_PAYMENT_REQUIRED?"Payment Required":a==this.HTTP_STATUS_FORBIDDEN?"Forbidden":a==this.HTTP_STATUS_NOT_FOUND?"Not found":a==this.HTTP_STATUS_PRECONDITION_FAILED?"Precondition Failed":a==this.HTTP_STATUS_INTERNAL_SERVER_ERROR?"Internal Server Error":"Other Error",b?a+" "+c:c}},BetaJS.Exceptions.Exception.extend("BetaJS.Modelling.ModelException",{constructor:function(a,b){this._inherited(BetaJS.Modelling.ModelException,"constructor",b),this.__model=a},model:function(){return this.__model}}),BetaJS.Modelling.ModelException.extend("BetaJS.Modelling.ModelMissingIdException",{constructor:function(a){this._inherited(BetaJS.Modelling.ModelMissingIdException,"constructor",a,"No id given.")}}),BetaJS.Modelling.ModelException.extend("BetaJS.Modelling.ModelInvalidException",{constructor:function(a){var b=BetaJS.Objs.values(a.errors()).join("\n");this._inherited(BetaJS.Modelling.ModelInvalidException,"constructor",a,b)}}),BetaJS.Properties.Properties.extend("BetaJS.Modelling.SchemedProperties",{constructor:function(a,b){this._inherited(BetaJS.Modelling.SchemedProperties,"constructor");var c=this.cls.scheme();this._properties_changed={},this.__errors={},this.__unvalidated={};for(var d in c)"def"in c[d]?this.set(d,c[d].def):c[d].auto_create?this.set(d,c[d].auto_create(this)):this.set(d,null);b=b||{},this._properties_changed={},this.__errors={};for(d in a)this.set(d,a[d])},_unsetChanged:function(a){delete this._properties_changed[a]},_beforeSet:function(a,b){var c=this.cls.scheme();if(!(a in c))return b;var d=c[a];return"boolean"==d.type?BetaJS.Types.parseBool(b):(d.transform&&(b=d.transform.apply(this,[b])),b)},_afterSet:function(a,b){var c=this.cls.scheme();if(a in c&&(this._properties_changed[a]=b,this.__unvalidated[a]=!0,delete this.__errors[a],c[a].after_set)){var d=BetaJS.Types.is_string(c[a].after_set)?this[c[a].after_set]:c[a].after_set;d.apply(this,[b])}},properties_changed:function(a){return BetaJS.Types.is_boolean(a)?BetaJS.Objs.filter(this._properties_changed,function(b,c){return this.validateAttr(c)==a},this):this._properties_changed},get_all_properties:function(){var a={},b=this.cls.scheme();for(var c in b)a[c]=this.get(c);return a},properties_by:function(a){return BetaJS.Types.is_boolean(a)?BetaJS.Objs.filter(this.get_all_properties(),function(b,c){return this.validateAttr(c)==a},this):this.get_all_properties()},validate:function(){this.trigger("validate");for(var a in this.__unvalidated)this.validateAttr(a);return this._customValidate(),BetaJS.Types.is_empty(this.__errors)},_customValidate:function(){},validateAttr:function(a){if(a in this.__unvalidated){delete this.__unvalidated[a],delete this.__errors[a];var b=this.cls.scheme(),c=b[a];if("validate"in c){var d=c.validate;BetaJS.Types.is_array(d)||(d=[d]);var e=this.get(a);BetaJS.Objs.iter(d,function(b){var c=b.validate(e,this);return c&&(this.__errors[a]=c),null===c},this)}this.trigger("validate:"+a,!(a in this.__errors),this.__errors[a])}return!(a in this.__errors)},setError:function(a,b){delete this.__unvalidated[a],this.__errors[a]=b,this.trigger("validate:"+a,!(a in this.__errors),this.__errors[a])},revalidate:function(){return this.__errors={},this.__unvalidated=this.keys(!0),this.validate()},errors:function(){return this.__errors},getError:function(a){return this.__errors[a]},asRecord:function(a){var b={},c=this.cls.scheme(),d=this.get_all_properties();a=a||{};for(var e in d)if(e in c){var f=c[e].tags||[],g={};BetaJS.Objs.iter(f,function(a){g[a]=!0});var h=!0;BetaJS.Objs.iter(a,function(a){h=h&&a in g},this),h&&(b[e]=d[e])}return b},setByTags:function(a,b){var c=this.cls.scheme();b=b||{};for(var d in a)if(d in c){var e=c[d].tags||[],f={};BetaJS.Objs.iter(e,function(a){f[a]=!0});var g=!0;BetaJS.Objs.iter(b,function(a){g=g&&a in f},this),g&&this.set(d,a[d])}},validation_exception_conversion:function(a){var b=a;if(a.instance_of(BetaJS.Stores.RemoteStoreException))b=a.source();else if(!("status_code"in b&&"data"in b))return a;return b.status_code()==BetaJS.Net.HttpHeader.HTTP_STATUS_PRECONDITION_FAILED&&b.data()&&(BetaJS.Objs.iter(b.data(),function(a,b){this.setError(b,a)},this),a=new BetaJS.Modelling.ModelInvalidException(model)),a}},{_initializeScheme:function(){return{}},asRecords:function(a,b){return a.map(function(a){return a.asRecord(b)})},filterPersistent:function(a){var b={},c=this.scheme();for(var d in a)(!BetaJS.Types.is_defined(c[d].persistent)||c[d].persistent)&&(b[d]=a[d]);return b}},{scheme:function(){return this.__scheme=this.__scheme||this._initializeScheme(),this.__scheme}}),BetaJS.Modelling.SchemedProperties.extend("BetaJS.Modelling.AssociatedProperties",{constructor:function(a,b){this._inherited(BetaJS.Modelling.AssociatedProperties,"constructor",a,b),this.assocs=this._initializeAssociations();for(var c in this.assocs)this.__addAssoc(c,this.assocs[c]);this.on("change:"+this.cls.primary_key(),function(a,b){this._change_id(a,b),this.trigger("change_id",a,b)},this)},_change_id:function(){},__addAssoc:function(a,b){this[a]=function(){return b.yield()}},_initializeAssociations:function(){return{}},destroy:function(){for(var a in this.assocs)this.assocs[a].destroy();this._inherited(BetaJS.Modelling.AssociatedProperties,"destroy")},id:function(){return this.get(this.cls.primary_key())},hasId:function(){return this.has(this.cls.primary_key())}},{primary_key:function(){return"id"},_initializeScheme:function(){var a=this._inherited(BetaJS.Modelling.AssociatedProperties,"_initializeScheme");return a[this.primary_key()]={type:"id"},a}}),BetaJS.Modelling.AssociatedProperties.extend("BetaJS.Modelling.Model",{constructor:function(a,b){b=b||{},this._inherited(BetaJS.Modelling.Model,"constructor",a,b),this.__saved="saved"in b?b.saved:!1,this.__new="new"in b?b["new"]:!0,this.__removed=!1,this.__saved&&(this._properties_changed={}),this.__table=b.table,this.__table._model_register(this),this.__destroying=!1},destroy:function(){this.__destroying||(this.__destroying=!0,this.__table._model_unregister(this),this.trigger("destroy"),this._inherited(BetaJS.Modelling.Model,"destroy"))},isSaved:function(){return this.__saved},isNew:function(){return this.__new},isRemoved:function(){return this.__removed},update:function(a,b){this.setAll(a,{silent:!0}),this.save(b)},_afterSet:function(a,b,c,d){this._inherited(BetaJS.Modelling.Model,"_afterSet",a,b,c,d);var e=this.cls.scheme();a in e&&(d&&d.no_change?this._unsetChanged(a):this.__saved=!1,d&&d.silent||this.__table&&this.__table._model_set_value(this,a,b,d))},_after_create:function(){},_before_create:function(){},save:function(a){var b=this,c=BetaJS.Objs.clone(a||{},1);return this.__new&&this._before_create(),c.success=function(){b.trigger("save"),b.__saved=!0;var c=b.__new;b.__new=!1,c&&b._after_create(),a&&a.success&&a.success()},this.__table._model_save(this,c)},remove:function(a){var b=this,c=BetaJS.Objs.clone(a||{},1);return c.success=function(){b.trigger("remove"),b.__removed=!0,a&&a.success&&a.success()},this.__table._model_remove(this,c)},table:function(){return this.__table}}),BetaJS.Class.extend("BetaJS.Modelling.Table",[BetaJS.Events.EventsMixin,{constructor:function(a,b,c){this._inherited(BetaJS.Modelling.Table,"constructor"),this.__store=a,this.__model_type=b,this.__models_by_id={},this.__models_changed={},this.__options=BetaJS.Objs.extend({model_cache_size:null,type_column:null,remove_exception:!0,auto_create:!1,create_exception:!0,invalid_create_exception:!0,invalid_create_save:!1,greedy_create:!1,store_validation_conversion:!0,auto_update:!0,update_exception:!0,invalid_update_exception:!0,invalid_update_save:!1,greedy_update:!1},c||{}),this.__models_by_cid=new BetaJS.Classes.ObjectCache({size:this.__options.model_cache_size}),this._auto_destroy(this.__models_by_cid),this.__models_by_cid.on("release",function(a){a.hasId()&&delete this.__models_by_id[a.id()]},this)},async_read:function(){return this.__store.async_read()},async_write:function(){return this.__store.async_write()},_model_register:function(a){this.hasModel(a)||(this.trigger("register",a),this.__models_by_cid.add(a),a.hasId()&&(this.__models_by_id[a.id()]=a),a.isNew()&&this.__options.auto_create&&this._model_create(a))},_model_unregister:function(a){this.hasModel(a)&&(a.save(),this.__models_by_cid.remove(a),a.hasId()&&delete this.__models_by_id[a.id()],this.trigger("unregister",a))},hasModel:function(a){return null!==this.__models_by_cid.get(a)},_model_remove:function(a,b){if(!this.hasModel(a))return!1;var c=this,d={success:function(){return b&&b.success&&b.success(),b&&b.complete&&b.complete(),c.trigger("remove",a),a.destroy(),!0},exception:function(a){if(b&&b.exception&&b.exception(a),b&&b.complete&&b.complete(),(!b||!b.exception)&&c.__options.remove_exception)throw a;return!1}};if(this.async_write())this.__store.remove(a.id(),d);else try{return this.__store.remove(a.id()),d.success()}catch(e){return d.exception(e)}return!1},_model_save:function(a,b){return a.isNew()?this._model_create(a,b):this._model_update(a,b)},__exception_conversion:function(a,b){return this.__options.store_validation_conversion?a.validation_exception_conversion(b):b},_model_create:function(a,b){if(!this.hasModel(a)||!a.isNew())return!1;var c=this,d=a.validate();if(!d){var e=new BetaJS.Modelling.ModelInvalidException(a);if(b&&b.exception&&b.exception(e),b&&b.complete&&b.complete(),(!b||!b.exception)&&c.__options.invalid_create_exception)throw e;if(!this.__options.invalid_create_save)return!1}var f=this.__options.greedy_create?a.properties_by(!0):a.get_all_properties();f=BetaJS.Scopes.resolve(this.__model_type).filterPersistent(f),this.__options.type_column&&(f[this.__options.type_column]=a.cls.classname);var g={success:function(e){if(!(a.cls.primary_key()in e))return g.exception(new BetaJS.Modelling.ModelMissingIdException(a));if(c.__models_by_id[e[a.cls.primary_key()]]=a,!c.__options.greedy_create)for(var f in a.properties_by(!1))delete e[f];return a.setAll(e,{no_change:!0,silent:!0}),d&&delete c.__models_changed[a.cid()],c.trigger("create",a),c.trigger("save",a),b&&b.success&&b.success(e),b&&b.complete&&b.complete(),!0},exception:function(d){if(d=BetaJS.Exceptions.ensure(d),d=c.__exception_conversion(a,d),b&&b.exception&&b.exception(d),b&&b.complete&&b.complete(),(!b||!b.exception)&&c.__options.create_exception)throw d;return!1}};if(this.async_write())this.__store.insert(f,g);else try{var h=this.__store.insert(f);return g.success(h)}catch(e){return g.exception(e)}return!0},_model_update:function(a,b){if(!this.hasModel(a)||a.isNew())return!1;var c=this,d=a.validate();if(!d){var e=new BetaJS.Modelling.ModelInvalidException(a);if(b&&b.exception&&b.exception(e),b&&b.complete&&b.complete(),(!b||!b.exception)&&c.__options.invalid_update_exception)throw e;if(!this.__options.invalid_update_save)return!1}var f=this.__options.greedy_update?a.properties_changed(!0):a.properties_changed();f=BetaJS.Scopes.resolve(this.__model_type).filterPersistent(f);var g={success:function(e){if(!c.__options.greedy_update)for(var f in a.properties_changed(!1))delete e[f];return a.setAll(e,{no_change:!0,silent:!0}),d&&delete c.__models_changed[a.cid()],c.trigger("update",a),c.trigger("save",a),b&&b.success&&b.success(e),b&&b.complete&&b.complete(),!0},exception:function(a){if(b&&b.exception&&b.exception(a),b&&b.complete&&b.complete(),(!b||!b.exception)&&c.__options.update_exception)throw a;return!1}};if(this.async_write()&&!BetaJS.Types.is_empty(f))this.__store.update(a.id(),f,g);else try{var h=BetaJS.Types.is_empty(f)?{}:this.__store.update(a.id(),f);return g.success(h)}catch(e){return g.exception(e)}return!0},_model_set_value:function(a,b,c,d){return this.__models_changed[a.cid()]=a,this.trigger("change",a,b,c),this.trigger("change:"+b,a,c),this.__options.auto_update?a.save(d):void 0},save:function(){var a=!0;return BetaJS.Objs.iter(this.__models_changed,function(b){a=b.save()&&a}),a},primary_key:function(){return BetaJS.Scopes.resolve(this.__model_type).primary_key()},__materialize:function(a){if(!a)return null;var b=this.__model_type;this.__options.type_column&&a[this.__options.type_column]&&(b=a[this.__options.type_column]);var c=BetaJS.Scopes.resolve(b);if(this.__models_by_id[a[this.primary_key()]])return this.__models_by_id[a[this.primary_key()]];var d=new c(a,{table:this,saved:!0,"new":!1});return d},findById:function(a){return this.__models_by_id[a]?this.__models_by_id[a]:this.__materialize(this.__store.get(a))},findBy:function(a){return this.allBy(a,{limit:1}).next()},all:function(a){return this.allBy({},a)},allBy:function(a,b){var c=this.__store.query(a,b),d=this,e=new BetaJS.Iterators.MappedIterator(c,function(a){return d.__materialize(a)});return e},active_query_engine:function(){if(!this._active_query_engine){var a=this;this._active_query_engine=new BetaJS.Queries.ActiveQueryEngine,this._active_query_engine._query=function(b){return a.allBy(b)},this.on("create",function(a){this._active_query_engine.insert(a)}),this.on("remove",function(a){this._active_query_engine.remove(a)}),this.on("change",function(a){this._active_query_engine.update(a)})}return this._active_query_engine},scheme:function(){return this.__model_type.scheme()},ensure_indices:function(){if(!("ensure_index"in this.__store))return!1;var a=this.scheme();for(var b in a)a[b].index&&this.__store.ensure_index(b);return!0}}]),BetaJS.Class.extend("BetaJS.Modelling.Associations.Association",{constructor:function(a,b){this._inherited(BetaJS.Modelling.Associations.Association,"constructor"),this._model=a,this._options=b||{},this.__cache=null,b.delete_cascade&&a.on("remove",function(){this.__delete_cascade()},this),b.ignore_change_id||a.on("change_id",function(a,b){this._change_id(a,b)},this)},_change_id:function(){},__delete_cascade:function(){for(var a=BetaJS.Iterators.ensure(this.yield());a.hasNext();)a.next().remove()},yield:function(){if(this.__cache)return this.__cache;var a=this._yield();return this._options.cached&&(this.__cache=a),a},invalidate:function(){delete this.__cache}}),BetaJS.Modelling.Associations.Association.extend("BetaJS.Modelling.Associations.TableAssociation",{constructor:function(a,b,c,d){this._inherited(BetaJS.Modelling.Associations.TableAssociation,"constructor",a,d),this._foreign_table=b,this._foreign_key=c,d.primary_key&&(this._primary_key=d.primary_key),this._options.cached&&this._foreign_table.on("create update remove",function(){this.invalidate()},this)},destroy:function(){this._foreign_table.off(null,null,this),this._inherited(BetaJS.Modelling.Associations.TableAssociation,"destroy")}}),BetaJS.Modelling.Associations.TableAssociation.extend("BetaJS.Modelling.Associations.HasManyAssociation",{_id:function(){return this._primary_key?this._model.get(this._primary_key):this._model.id()},_yield:function(){return this.allBy({})},yield:function(){return this._options.cached?(this.__cache||(this.__cache=this._yield().asArray()),BetaJS.Objs.iter(this.__cache,function(a){a.on("destroy",function(){this.invalidate()},this)},this),new BetaJS.Iterators.ArrayIterator(this.__cache)):this._yield()},invalidate:function(){BetaJS.Objs.iter(this.__cache,function(a){a.off(null,null,this)},this),this._inherited(BetaJS.Modelling.Associations.HasManyAssociation,"invalidate")},findBy:function(a){return a[this._foreign_key]=this._id(),this._foreign_table.findBy(a)},allBy:function(a){return a[this._foreign_key]=this._id(),this._foreign_table.allBy(a)},_change_id:function(a){for(var b=this._yield();b.hasNext();){var c=b.next();c.set(this._foreign_key,a),c.save()}}}),BetaJS.Modelling.Associations.HasManyAssociation.extend("BetaJS.Modelling.Associations.HasManyThroughArrayAssociation",{_yield:function(){var a=[];return BetaJS.Objs.iter(this._model.get(this._foreign_key),function(b){var c=this._foreign_table.findById(b);c&&a.push(c)},this),a},yield:function(){return this._options.cached?(this.__cache||(this.__cache=this._yield()),BetaJS.Objs.iter(this.__cache,function(a){a.on("destroy",function(){this.invalidate()},this)},this),new BetaJS.Iterators.ArrayIterator(this.__cache)):new BetaJS.Iterators.ArrayIterator(this._yield())}}),BetaJS.Modelling.Associations.TableAssociation.extend("BetaJS.Modelling.Associations.HasOneAssociation",{_yield:function(a){var b={};b[this._foreign_key]=a?a:this._primary_key?this._model.get(this._primary_key):this._model.id();var c=this._foreign_table.findBy(b);return c&&c.on("destroy",function(){this.invalidate()},this),c},_change_id:function(a,b){var c=this._yield(b);c&&(c.set(this._foreign_key,a),c.save())}}),BetaJS.Modelling.Associations.TableAssociation.extend("BetaJS.Modelling.Associations.BelongsToAssociation",{_yield:function(){var a=null;if(this._primary_key){var b={};b[this._primary_key]=this._model.get(this._foreign_key),a=this._foreign_table.findBy(b)}else a=this._foreign_table.findById(this._model.get(this._foreign_key));return a&&a.on("destroy",function(){this.invalidate()},this),a}}),BetaJS.Modelling.Associations.Association.extend("BetaJS.Modelling.Associations.ConditionalAssociation",{constructor:function(a,b){this._inherited(BetaJS.Modelling.Associations.ConditionalAssociation,"constructor"),this._model=a,this._options=b||{},this.__cache=null,b.delete_cascade&&a.on("remove",function(){this.__delete_cascade()},this),b.ignore_change_id||a.on("change_id",function(a,b){this._change_id(a,b)},this)},_yield:function(){return this._model.assocs[this._options.conditional(this._model)]}}),BetaJS.Modelling.Associations.Association.extend("BetaJS.Modelling.Associations.PolymorphicHasOneAssociation",{constructor:function(a,b,c,d){this._inherited(BetaJS.Modelling.Associations.PolymorphicHasOneAssociation,"constructor",a,d),this._foreign_table_key=b,this._foreign_key=c,d.primary_key&&(this._primary_key=d.primary_key)},_yield:function(a){var b={};b[this._foreign_key]=a?a:this._primary_key?this._model.get(this._primary_key):this._model.id();var c=BetaJS.Scopes.resolve(this._model.get(this._foreign_table_key)),d=c?c.findBy(b):null;return d&&d.on("destroy",function(){this.invalidate()},this),d},_change_id:function(a,b){var c=this._yield(b);c&&(c.set(this._foreign_key,a),c.save())}}),BetaJS.Class.extend("BetaJS.Modelling.Validators.Validator",{validate:function(){return null}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.PresentValidator",{constructor:function(a){this._inherited(BetaJS.Modelling.Validators.PresentValidator,"constructor"),this.__error_string=a?a:"Field is required"},validate:function(a){return BetaJS.Types.is_null(a)||""===a?this.__error_string:null}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.EmailValidator",{constructor:function(a){this._inherited(BetaJS.Modelling.Validators.EmailValidator,"constructor"),this.__error_string=a?a:"Not a valid email address"},validate:function(a){return BetaJS.Strings.is_email_address(a)?null:this.__error_string}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.LengthValidator",{constructor:function(a){this._inherited(BetaJS.Modelling.Validators.LengthValidator,"constructor"),this.__min_length=BetaJS.Types.is_defined(a.min_length)?a.min_length:null,this.__max_length=BetaJS.Types.is_defined(a.max_length)?a.max_length:null,this.__error_string=BetaJS.Types.is_defined(a.error_string)?a.error_string:null,this.__error_string||(null!==this.__min_length?this.__error_string=null!==this.__max_length?"Between "+this.__min_length+" and "+this.__max_length+" characters":"At least "+this.__min_length+" characters":null!==this.__max_length&&(this.__error_string="At most "+this.__max_length+" characters"))},validate:function(a){return null!==this.__min_length&&(!a||a.length<this.__min_length)?this.__error_string:null!==this.__max_length&&a.length>this.__max_length?this.__error_string:null}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.UniqueValidator",{constructor:function(a,b){this._inherited(BetaJS.Modelling.Validators.UniqueValidator,"constructor"),this.__key=a,this.__error_string=b?b:"Key already present"},validate:function(a,b){var c={};c[this.__key]=a;var d=b.table().findBy(c);return!d||!b.isNew()&&b.id()==d.id()?null:this.__error_string}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.ConditionalValidator",{constructor:function(a,b){this._inherited(BetaJS.Modelling.Validators.ConditionalValidator,"constructor"),this.__condition=a,this.__validator=BetaJS.Types.is_array(b)?b:[b]},validate:function(a,b){if(!this.__condition(a,b))return null;for(var c=0;c<this.__validator.length;++c){var d=this.__validator[c].validate(a,b);if(null!==d)return d}return null}}),BetaJS.Net.AbstractAjax.extend("BetaJS.Server.Net.HttpAjax",{_syncCall:function(){throw"Unsupported"},_asyncCall:function(a){var b=BetaJS.Net.Uri.parse(a.uri),c={method:a.method,host:b.host,port:b.port,path:b.path},d=null;a.data&&("GET"==c.method?c.path=c.path+"?"+this.cls.querystring().stringify(a.data):(d=this.cls.querystring().stringify(a.data),d.length>0&&(c.headers={"Content-Type":"application/x-www-form-urlencoded","Content-Length":d.length})));var e=this.cls.http().request(c,function(b){var c="";b.on("data",function(a){c+=a}).on("end",function(){b.statusCode>=200&&b.statusCode<300?a&&(a.success?a.success(c):callbacks(c)):a.failure&&a.failure(c)})});d&&d.length>0&&e.write(d),e.end()}},{__http:null,http:function(){return this.__http||(this.__http=require("http")),this.__http},__querystring:null,querystring:function(){return this.__querystring||(this.__querystring=require("querystring")),this.__querystring}}),BetaJS.Class.extend("BetaJS.Databases.Database",{_tableClass:function(){return null},getTable:function(a){var b=this._tableClass();return new b(this,a)}}),BetaJS.Class.extend("BetaJS.Databases.DatabaseTable",{constructor:function(a,b){this._inherited(BetaJS.Databases.DatabaseTable,"constructor"),this._database=a,this._table_name=b},_encode:function(a){return a},_decode:function(a){return a},_insertRow:function(){},_removeRow:function(){},_findOne:function(){},_updateRow:function(){},_find:function(){},insertRow:function(a){return this._decode(this._insertRow(this._encode(a)))},removeRow:function(a){return this._removeRow(this._encode(a))},findOne:function(a,b){var c=this._findOne(this._encode(a),b);return c?this._decode(c):null},updateRow:function(a,b){return this._decode(this._updateRow(this._encode(a),this._encode(b)))},find:function(a,b){var c=this;return new BetaJS.Iterators.MappedIterator(this._find(this._encode(a),b),function(a){return c._decode(a)})},removeById:function(a){return this.removeRow({id:a})},findById:function(a){return this.findOne({id:a})},updateById:function(a,b){return this.updateRow({id:a},b)},ensureIndex:function(){}}),BetaJS.Databases.Database.extend("BetaJS.Databases.MongoDatabase",{constructor:function(a,b){if(BetaJS.Types.is_string(b)){var c=BetaJS.Net.Uri.parse(b);b={database:BetaJS.Strings.strip_start(c.path,"/"),server:c.host,port:c.port,username:c.user,password:c.password}}this.__options=BetaJS.Objs.extend({database:"database",server:"localhost",port:27017},b||{}),this._inherited(BetaJS.Databases.MongoDatabase,"constructor"),this.__mongodb=null,this.__mongo_sync=a},_tableClass:function(){return BetaJS.Databases.MongoDatabaseTable},mongo_sync:function(){return this.__mongo_sync},mongodb:function(){return this.__mongodb||(this.__mongo_server=new this.__mongo_sync.Server(this.__options.server+":"+this.__options.port),this.__mongodb=this.__mongo_server.db(this.__options.database),this.__options.username&&this.__mongodb.auth(this.__options.username,this.__options.password)),this.__mongodb},destroy:function(){this.__mongo_server&&this.__mongo_server.close(),this._inherited(BetaJS.Databases.MongoDatabase,"destroy")}}),BetaJS.Databases.DatabaseTable.extend("BetaJS.Databases.MongoDatabaseTable",{constructor:function(a,b){this._inherited(BetaJS.Databases.MongoDatabaseTable,"constructor",a,b),this.__table=null},table:function(){return this.__table||(this.__table=this._database.mongodb().getCollection(this._table_name)),this.__table},_encode:function(a){var b=BetaJS.Objs.clone(a,1);return"id"in a&&(delete b.id,b._id=a.id),b},_decode:function(a){var b=BetaJS.Objs.clone(a,1);return"_id"in a&&(delete b._id,b.id=a._id),b},_insertRow:function(a){var b=this.table().insert(a);return b[0]?b[0]:b},_removeRow:function(a){return this.table().remove(a)},_findOne:function(a,b){b=b||{},b.limit=1;var c=this._find(a,b);return c.next()},_updateRow:function(a,b){return this.table().update(a,{$set:b},!0,!1),b},_find:function(a,b){b=b||{};var c=this.table().find(a);return"sort"in b&&(c=c.sort(b.sort)),"skip"in b&&(c=c.skip(b.skip)),"limit"in b&&(c=c.limit(b.limit)),new BetaJS.Iterators.ArrayIterator(c.toArray())},ensureIndex:function(a){var b={};return b[a]=1,this.table().ensureIndex(b)}}),BetaJS.Stores.BaseStore.extend("BetaJS.Stores.DatabaseStore",{constructor:function(a,b){this._inherited(BetaJS.Stores.DatabaseStore,"constructor"),this.__database=a,this.__table_name=b,this.__table=null},table:function(){return this.__table||(this.__table=this.__database.getTable(this.__table_name)),this.__table},_insert:function(a){return this.table().insertRow(a)},_remove:function(a){return this.table().removeById(a)},_get:function(a){return this.table().findById(a)},_update:function(a,b){return this.table().updateById(a,b)},_query_capabilities:function(){return{query:!0,sort:!0,skip:!0,limit:!0}},_query:function(a,b){return this.table().find(a,b)},_ensure_index:function(a){this.table().ensureIndex(a)}}),BetaJS.Stores.ConversionStore.extend("BetaJS.Stores.MongoDatabaseStore",{constructor:function(a,b,c){var d=new BetaJS.Stores.DatabaseStore(a,b),e={},f={};c=c||{},c.id="id";var g=a.mongo_sync().ObjectId;for(var h in c)"id"==c[h]&&(e[h]=function(a){return a?new g(a):null},f[h]=function(a){return a?a+"":null});this._inherited(BetaJS.Stores.MongoDatabaseStore,"constructor",d,{value_encoding:e,value_decoding:f})}}),BetaJS.Class.extend("BetaJS.Stores.Migrator",{constructor:function(){this._inherited(BetaJS.Stores.Migrator,"constructor"),this.__version=null,this.__migrations=[],this.__sorted=!0},version:function(){return this.__version||(this.__version=this._getVersion()),this.__version},_getVersion:function(){},_setVersion:function(){},_log:function(){},migrations:function(){return this.__sorted||(this.__migrations.sort(function(a,b){return a.version-b.version}),this.__sorted=!0),this.__migrations},register:function(a){this.__migrations.push(a),this.__sorted=!1},_indexByVersion:function(a){for(var b=0;b<this.__migrations.length;++b){if(a==this.__migrations[b].version)return b;
if(a<this.__migrations[b].version)return b-1}return this.__migrations.length},migrate:function(a){for(var b=this._indexByVersion(this.version()),c=BetaJS.Types.is_defined(a)?this._indexByVersion(a):this.__migrations.length-1;c>b;){var d=this.__migrations[b+1];this._log("Migrate "+d.version+": "+d.title+" - "+d.description+"...\n");try{d.migrate(),this._setVersion(this.__migrations[b+1].version),b++,this._log("Successfully migrated "+d.version+".\n")}catch(e){this._log("Failure! Rolling back "+d.version+"...\n");try{d.partial_rollback()}catch(e){throw this._log("Failure! Couldn't roll back "+d.version+"!\n"),e}throw this._log("Rolled back "+d.version+"!\n"),e}}},rollback:function(a){for(var b=this._indexByVersion(this.version()),c=BetaJS.Types.is_defined(a)?this._indexByVersion(c):-1;b>c;){var d=this.__migrations[b];this._log("Rollback "+d.version+": "+d.title+" - "+d.description+"...\n");try{d.rollback(),this._setVersion(b>=1?this.__migrations[b-1].version:0),b--,this._log("Successfully rolled back "+d.version+".\n")}catch(e){throw this._log("Failure! Couldn't roll back "+d.version+"!\n"),e}}}});
