...
}}),BetaJS.Modelling.Associations.Association.extend("BetaJS.Modelling.Associations.PolymorphicHasOneAssociation",{constructor:function(t,e,i,s){this._inherited(BetaJS.Modelling.Associations.PolymorphicHasOneAssociation,"constructor",t,s),this._foreign_table_key=e,this._foreign_key=i,s.primary_key&&(this._primary_key=s.primary_key)},_yield:function(t,e){var i={};i[this._foreign_key]=e?e:this._primary_key?this._model.get(this._primary_key):this._model.id();var s=BetaJS.Scopes.resolve(this._model.get(this._foreign_table_key));return this.then(s,s.findBy,[i],t,function(t,e){t&&t.on("destroy",function(){this.invalidate()},this),this.callback(e,"success",t)})},_change_id:function(t,e){this._yield({success:function(e){e&&(e.set(this._foreign_key,t),e.save())}},e)}}),BetaJS.Class.extend("BetaJS.Modelling.Validators.Validator",{validate:function(){return null}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.PresentValidator",{constructor:function(t){this._inherited(BetaJS.Modelling.Validators.PresentValidator,"constructor"),this.__error_string=t?t:"Field is required"},validate:function(t){return BetaJS.Types.is_null(t)||""===t?this.__error_string:null}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.EmailValidator",{constructor:function(t){this._inherited(BetaJS.Modelling.Validators.EmailValidator,"constructor"),this.__error_string=t?t:"Not a valid email address"},validate:function(t){return BetaJS.Strings.is_email_address(t)?null:this.__error_string}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.LengthValidator",{constructor:function(t){this._inherited(BetaJS.Modelling.Validators.LengthValidator,"constructor"),this.__min_length=BetaJS.Types.is_defined(t.min_length)?t.min_length:null,this.__max_length=BetaJS.Types.is_defined(t.max_length)?t.max_length:null,this.__error_string=BetaJS.Types.is_defined(t.error_string)?t.error_string:null,this.__error_string||(null!==this.__min_length?this.__error_string=null!==this.__max_length?"Between "+this.__min_length+" and "+this.__max_length+" characters":"At least "+this.__min_length+" characters":null!==this.__max_length&&(this.__error_string="At most "+this.__max_length+" characters"))},validate:function(t){return null!==this.__min_length&&(!t||t.length<this.__min_length)?this.__error_string:null!==this.__max_length&&t.length>this.__max_length?this.__error_string:null}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.UniqueValidator",{constructor:function(t,e){this._inherited(BetaJS.Modelling.Validators.UniqueValidator,"constructor"),this.__key=t,this.__error_string=e?e:"Key already present"},validate:function(t,e){var i={};i[this.__key]=t;var s=e.table().findBy(i);return!s||!e.isNew()&&e.id()==s.id()?null:this.__error_string}}),BetaJS.Modelling.Validators.Validator.extend("BetaJS.Modelling.Validators.ConditionalValidator",{constructor:function(t,e){this._inherited(BetaJS.Modelling.Validators.ConditionalValidator,"constructor"),this.__condition=t,this.__validator=BetaJS.Types.is_array(e)?e:[e]},validate:function(t,e){if(!this.__condition(t,e))return null;for(var i=0;this.__validator.length>i;++i){var s=this.__validator[i].validate(t,e);if(null!==s)return s}return null}}),BetaJS.Net.AbstractAjax.extend("BetaJS.Server.Net.HttpAjax",{_syncCall:function(){throw"Unsupported"},_asyncCall:function(t,e){var i=BetaJS.Net.Uri.parse(t.uri),s={method:t.method,host:i.host,port:i.port,path:i.path},n=null;t.data&&("GET"==s.method?s.path=s.path+"?"+this.cls.querystring().stringify(t.data):(n=this.cls.querystring().stringify(t.data),n.length>0&&(s.headers={"Content-Type":"application/x-www-form-urlencoded","Content-Length":n.length})));var r=this.cls.http().request(s,function(t){var i="";t.on("data",function(t){i+=t}).on("end",function(){t.statusCode>=200&&300>t.statusCode?BetaJS.SyncAsync.callback(e,"success",i):BetaJS.SyncAsync.callback(e,"exception",i)})});n&&n.length>0&&r.write(n),r.end()}},{__http:null,http:function(){return this.__http||(this.__http=require("http")),this.__http},__querystring:null,querystring:function(){return this.__querystring||(this.__querystring=require("querystring")),this.__querystring}}),BetaJS.Class.extend("BetaJS.Server.Net.Controller",{},{dispatch:function(t,e,i,s){var n=this;n[t](e,i,{success:function(){BetaJS.Types.is_defined(s)&&s()},exception:function(t){t=BetaJS.Server.Net.ControllerException.ensure(t),i.status(t.code()).send(JSON.stringify(t.data()))}})}}),BetaJS.Exceptions.Exception.extend("BetaJS.Server.Net.ControllerException",{constructor:function(t,e){e=e||{},this.__data=e,this.__code=t,this._inherited(BetaJS.Server.Net.ControllerException,"constructor",BetaJS.Net.HttpHeader.format(t,!0))},code:function(){return this.__code},data:function(){return this.__data}}),BetaJS.Class.extend("BetaJS.Server.Net.Imap",[BetaJS.Events.EventsMixin,{constructor:function(t,e){this._inherited(BetaJS.Server.Net.Imap,"constructor"),this.__quoted_printable=require("quoted-printable"),this.__html_strip=require("htmlstrip-native"),this.__auth=t,e=e||{},this.__options=e,this.__count=0,this.__Imap=require("imap"),this.__connected=!1,this.__imap=new this.__Imap(BetaJS.Objs.extend({tls:!0,tlsOptions:{rejectUnauthorized:!1}},t));var i=this;this.__imap.on("mail",function(t){i.__count+=t}),this.__imap.on("error",function(){i.trigger("error"),e.reconnect_on_error&&BetaJS.SyncAsync.eventually(i.reconnect,[],i)})},destroy:function(){this.disconnect(),this._inherited(BetaJS.Server.Net.Imap,"destroy")},connect:function(t){if(!this.__connected){this.__count=0;var e=this,i=function(){BetaJS.SyncAsync.callback(t,"exception"),e.off("error",i)};this.on("error",i),this.__imap.connect(),this.__imap.once("ready",function(){e.__connected=!0;var s=e.__options.mailbox||"INBOX";BetaJS.Types.is_array(s)||(s=[s]),s=BetaJS.Objs.clone(s,1);var n=null,r=function(){if(0===s.length)throw BetaJS.SyncAsync.callback(t,"exception",n),e.__connected=!1,n;var o=s.shift();e.__imap.openBox(o,!0,function(s){return s?(n=s,r(),void 0):(e.on("error",i),e.__imap.on("mail",function(t){e.trigger("new_mail",t)}),BetaJS.SyncAsync.callback(t,"success"),void 0)})};e.off("error",i),r()})}},disconnect:function(){this.__connected&&(this.__imap.end(),this.__connected=!1)},reconnect:function(){this.disconnect(),this.connect()},count:function(){return this.__count},fetch:function(t,e){t=t||{};var i=[];"headers"in t&&!t.headers||i.push("HEADER.FIELDS (FROM TO SUBJECT DATE)"),"body"in t&&!t.body||i.push("TEXT");var s=1,n=100;if(t.seq_count?t.seq_end?(n=t.seq_end,s=n-t.seq_count+1):(s=t.seq_start||s,n=s+t.seq_count-1):(s=t.seq_start||s,n=t.seq_end||s+99),t.reverse){var r=n-s;n=this.__count-s+1,s=n-r}var o=this.__imap.seq.fetch(s+":"+n,{bodies:i,struct:!0});this.__query(o,e)},__query:function(t,e){var i=this,s=[];t.on("message",function(t,e){var n={},r="",o="";t.on("body",function(t,e){t.on("data",function(t){"TEXT"===e.which?o+=t.toString("utf8"):r+=t.toString("utf8")})}),t.once("attributes",function(t){n=t}),t.once("end",function(){n.seqno=e;try{var t=i.__parse(i.__Imap.parseHeader(r),o,n);t&&s.push(t)}catch(a){}})}),t.once("error",function(t){BetaJS.SyncAsync.callback(e,"exception",t)}),t.once("end",function(){BetaJS.SyncAsync.callback(e,"success",s)})},__parse:function(t,e,i){this.trigger("parse",t,e,i);var s={};if(s.uid=i.uid,s.threadid=i["x-gm-thrid"],s.id=i.uid,s.seqid=i.seqno,t&&t.subject&&t.subject.length>0&&(s.subject=t.subject[0]),t&&t.to&&t.to.length>0&&(s.to=t.to[0]),t&&t.from&&t.from.length>0&&(s.from=t.from[0]),t&&t.date&&t.date.length>0){var n=new Date(t.date[0]);s.date=n.getTime()}if(e){var r=i.struct,o=[];if(r.length>1)for(var a=r[0].params.boundary,_=e,c=_.indexOf(a),u=1;r.length>u;++u){var h=r[u][0]||{};if(_=_.substring(_.indexOf(a)+a.length),_=_.substring(_.indexOf("\r\n\r\n")+"\r\n\r\n".length),!h.disposition&&"text"==h.type){var l=_.indexOf(a)-c;o.push({meta:h,body:l>=0?_.substring(0,l):_})}}else o.push({meta:r[0],body:e});for(var d=null,f=null,p=0;o.length>p;++p){var S=o[p].body,y=o[p].meta.encoding.toLowerCase();try{S="quoted-printable"==y?""+this.__quoted_printable.decode(S):""+new Buffer(S,y)}catch(m){}"html"==o[p].meta.subtype?d=S:f=S}!f&&d&&(f=this.__html_strip.html_strip(d,{include_script:!1,include_style:!1,compact_whitespace:!0})),s.html_body=d,s.text_body=f}return s}}]),BetaJS.Server.Net.Smtp={send:function(t,e,i){var s=require("emailjs");e.from=BetaJS.Strings.email_get_email(e.from),e.to=BetaJS.Strings.email_get_email(e.to),e.text_body&&(e.text=e.text_body,delete e.text_body),s.server.connect(t).send(s.message.create(e),function(t,e){t?BetaJS.SyncAsync.callback(i,"exception",t):BetaJS.SyncAsync.callback(i,"success",e)})}},BetaJS.Class.extend("BetaJS.Server.Sessions.Manager",[BetaJS.Events.EventsMixin,BetaJS.Classes.HelperClassMixin,{_session_class:"BetaJS.Server.Sessions.Session",constructor:function(t){this._inherited(BetaJS.Server.Sessions.Manager,"constructor"),t=BetaJS.Objs.tree_extend({invalidation:{session_timeout:864e5,session_inactivity_timeout:36e5,timer:6e4}},t),this.__options=t,this._session_class=t.session_class||this._session_class,BetaJS.Types.is_string(this._session_class)&&(this._session_class=BetaJS.Scopes.resolve(this._session_class)),t.invalidation.timer&&(this.__timer=this._auto_destroy(new BetaJS.Timers.Timer({fire:this.invalidate,context:this,delay:t.invalidation.timer}))),this.__sessions=new BetaJS.Lists.ObjectIdList},destroy:function(){this.iterate(function(t){t.destroy()}),this.__sessions.destroy(),this._inherited(BetaJS.Server.Sessions.Manager,"destroy")},iterate:function(t,e){this.__sessions.iterate(t,e||this)},obtain_session:function(t,e,i){this.find_session(t,{context:this,success:function(s){BetaJS.SyncAsync.callback(i,"success",s||this.new_session(t,e))}})},__generate_token:function(){return BetaJS.Tokens.generate_token()},__lookup_session:function(t,e){this._helper({method:"__lookup_session",callbacks:e},t,e)},find_session:function(t,e){var i=this.__sessions.get(t);i?BetaJS.SyncAsync.callback(e,"success",i):this.__lookup_session(t,e)},__add_session:function(t){this.__sessions.add(t),this._helper("__add_session",t)},new_session:function(t,e){return session=new this._session_class(this,t||this.__generate_token(),e),this.__add_session(session),session},invalidate:function(){this.iterate(function(t){t.invalidate()})},options:function(){return this.__options},__remove_session:function(t){this.__sessions.exists(t)&&(this._helper("remove_session",t),this.__sessions.remove(t))},delete_session:function(t){t.destroy()}}]),BetaJS.Class.extend("BetaJS.Server.Sessions.Session",[BetaJS.Classes.HelperClassMixin,{constructor:function(t,e,i){this._inherited(BetaJS.Server.Sessions.Session,"constructor"),this.__manager=t,this.__options=i,BetaJS.Ids.objectId(this,e),this.initiation_time=BetaJS.Time.now(),this.active_time=this.initiation_time},destroy:function(){this.__manager.__remove_session(this),this._inherited(BetaJS.Server.Sessions.Session,"destroy")},is_active:function(){return this._helper({method:"is_active",fold_start:!1,fold:function(t,e){return t||e}})},activity:function(){this.active_time=BetaJS.Time.now()},invalidate:function(){this._helper("invalidate");var t=this.__manager.options().invalidation,e=BetaJS.Time.now();(t.session_timeout&&e>this.initiation_time+t.session_timeout||!this.is_active()&&t.session_inactivity_timeout&&e>this.active_time+t.session_inactivity_timeout)&&this.destroy()},manager:function(){return this.__manager},options:function(){return this.__options}}]),BetaJS.Class.extend("BetaJS.Server.Session.ActiveSessionManagerHelper",{_active_session_class:"BetaJS.Server.Sessions.ActiveSession",constructor:function(t,e){this._inherited(BetaJS.Server.Session.ActiveSessionManagerHelper,"constructor"),e=BetaJS.Objs.tree_extend({invalidation:{active_session_timeout:36e5,active_session_inactivity_timeout:6e4}},e),this.__options=e,this._active_session_class=e.active_session_class||this._active_session_class,BetaJS.Types.is_string(this._active_session_class)&&(this._active_session_class=BetaJS.Scopes.resolve(this._active_session_class)),t.__add_active_session=function(t,e){this._helper("__add_active_session",t,e)}},__add_session:function(t){t.addHelper(BetaJS.Server.Session.ActiveSessionHelper,this)},options:function(){return this.__options}}),BetaJS.Class.extend("BetaJS.Server.Session.ActiveSessionHelper",[BetaJS.Classes.HelperClassMixin,{constructor:function(t,e){this._inherited(BetaJS.Server.Session.ActiveSessionHelper,"constructor"),this.__helper=e,this.__session=t,t.active_sessions=this,this.__active_sessions=new BetaJS.Lists.ObjectIdList},destroy:function(){this.iterate(function(t){t.destroy()},this),this.__active_sessions.destroy(),this._inherited(BetaJS.Server.Session.ActiveSessionHelper,"destroy")},session:function(){return this.__session},helper:function(){return this.__helper},invalidate:function(){this.iterate(function(t){t.invalidate()},this)},iterate:function(t,e){this.__active_sessions.iterate(t,e||this)},is_active:function(){return this.__active_sessions.count()>0},find_active_session:function(t){return this.__active_sessions.get(t)},__generate_token:function(){return BetaJS.Tokens.generate_token()},__remove_active_session:function(t){this.__active_sessions.exists(t)&&(this.__active_sessions.remove(t),this.__session.activity())},delete_active_session:function(t){t.destroy()},obtain_active_session:function(t,e){return this.find_active_session(t)||this.new_active_session(t,e)},__add_active_session:function(t){this.__active_sessions.add(t),this.session().manager().__add_active_session(this.session(),t)},new_active_session:function(t,e){return active_session=new this.__helper._active_session_class(this,t||this.__generate_token(),e),this.__add_active_session(active_session),active_session},continue_active_session:function(t){var e=null;return this.iterate(function(i){return i.suspended()&&i.can_continue(t)?(e=i,!1):!0}),e},attach_active_session:function(t){return this.continue_active_session(t)||this.new_active_session(null,t)}}]),BetaJS.Class.extend("BetaJS.Server.Sessions.ActiveSession",[BetaJS.Classes.HelperClassMixin,BetaJS.Events.EventsMixin,{constructor:function(t,e,i){this._inherited(BetaJS.Server.Sessions.ActiveSession,"constructor"),this.__helper=t,this.__options=i||{},BetaJS.Ids.objectId(this,e),this.initiation_time=BetaJS.Time.now(),this.active_time=this.initiation_time},destroy:function(){this.trigger("destroy"),this.__helper.__remove_active_session(this),this._inherited(BetaJS.Server.Sessions.ActiveSession,"destroy")},options:function(){return this.__options},activity:function(){this.active_time=BetaJS.Time.now()},suspended:function(){return this._helper({method:"suspended",fold_start:!1,fold:function(t,e){return t||e}})},can_continue:function(){return!1},invalidate:function(){var t=this.__helper.helper().options().invalidation,e=BetaJS.Time.now();(t.active_session_timeout&&e>this.initiation_time+t.active_session_timeout||this.suspended()&&t.active_session_inactivity_timeout&&e>this.active_time+t.active_session_inactivity_timeout)&&this.destroy()}}]),BetaJS.Class.extend("BetaJS.Server.Session.PersistentSessionManagerHelper",{_persistent_session_model:"BetaJS.Server.Sessions.PersistentSessionModel",constructor:function(t,e){this._inherited(BetaJS.Server.Session.PersistentSessionManagerHelper,"constructor"),this.__manager=t,e=BetaJS.Objs.tree_extend({invalidation:{session_timeout:31536e6,timer:864e5}},e),this.__options=e,this.__store=e.store?e.store:this._auto_destroy(new BetaJS.Stores.MemoryStore),this._persistent_session_model=e.persistent_session_model||this._persistent_session_model,BetaJS.Types.is_string(this._persistent_session_model)&&(this._persistent_session_model=BetaJS.Scopes.resolve(this._persistent_session_model)),e.invalidation.timer&&(this.__timer=this._auto_destroy(new BetaJS.Timers.Timer({fire:this.invalidate,context:this,delay:e.invalidation.timer}))),this.__table=this._auto_destroy(new BetaJS.Modelling.Table(this.__store,this._persistent_session_model))},__lookup_session:function(t,e){this.__table.findBy({token:t},{context:this,success:function(i){if(i){var s=this.__manager.new_session(t,{model:i});BetaJS.SyncAsync.callback(e,"success",s)}else BetaJS.SyncAsync.callback(e,"success",null)},failure:function(){BetaJS.SyncAsync.callback(e,"success",null)}})},__add_session:function(t){var e=t.options();e.model||(e.model=new this._persistent_session_model({token:t.cid(),created:BetaJS.Time.now()}),e.model.save()),t.model=e.model,t.model.session=t},options:function(){return this.__options},invalidate:function(){if(this.__options.invalidation.session_timeout){var t=BetaJS.Time.now()-this.__options.invalidation.session_timeout;this.__table.allBy({created:{$lt:t}},{},{context:this,success:function(t){for(;t.hasNext();){var e=t.next();e.session&&this.__manager.delete_session(e.session),e.remove()}}})}}}),BetaJS.Modelling.Model.extend("BetaJS.Server.Sessions.PersistentSessionModel",{},{_initializeScheme:function(){var t=this._inherited(BetaJS.Server.Sessions.PersistentSessionModel,"_initializeScheme");return t.token={type:"string",index:!0},t.created={type:"date",index:!0},t}}),BetaJS.Class.extend("BetaJS.Server.Session.RMIManagerHelper",{__add_active_session:function(t,e){e.addHelper(BetaJS.Server.Session.RMIHelper)}}),BetaJS.Class.extend("BetaJS.Server.Session.RMIHelper",{constructor:function(t){this._inherited(BetaJS.Server.Session.RMIHelper,"constructor"),this.__active_session=t,t.rmi=this,this.__rmi_sender=new BetaJS.Net.SocketSenderChannel(null,"rmi",!1),this.__rmi_receiver=new BetaJS.Net.SocketReceiverChannel(null,"rmi"),this.__rmi_peer=new BetaJS.RMI.Peer(this.__rmi_sender,this.__rmi_receiver),t.rmi_peer=this.__rmi_peer,this.stubs={},this.skeletons={},t.stubs=this.stubs,t.skeletons=this.skeletons,t.on("bind_socket",function(t){this.__rmi_receiver.socket(t),this.__rmi_sender.socket(t),this.__rmi_sender.ready()},this),t.on("unbind_socket",function(){this.__rmi_sender.unready()},this),"initialize_rmi"in t&&t.initialize_rmi()},destroy:function(){for(var t in this.stubs)this.stubs[t].destroy;for(t in this.skeletons)this.skeletons[t].destroy;this.__rmi_peer.destroy(),this.__rmi_receiver.destroy(),this.__rmi_sender.destroy(),this._inherited(BetaJS.Server.Session.RMIHelper,"destroy")}}),BetaJS.Class.extend("BetaJS.Server.Session.SocketsManagerHelper",{constructor:function(t){this._inherited(BetaJS.Server.Session.SocketsManagerHelper,"constructor"),this.__manager=t,t.bind_socket=function(t,e,i){var s=BetaJS.Strings.read_cookie_string(t.handshake.headers.cookie,e,i);this.find_session(s,{context:this,success:function(e){if(!e)return t.disconnect(),void 0;var s=e.active_sessions.find_active_session(i.active_session_token);return s?(s.socket.bind(t),void 0):(t.disconnect(),void 0)}})}},__add_active_session:function(t,e){e.addHelper(BetaJS.Server.Session.SocketsHelper)}}),BetaJS.Class.extend("BetaJS.Server.Session.SocketsHelper",{constructor:function(t){this._inherited(BetaJS.Server.Session.SocketsHelper,"constructor"),this.__active_session=t,t.socket=this},destroy:function(){this.unbind_socket(),this._inherited(BetaJS.Server.Session.SocketsHelper,"destroy")},suspended:function(){return!this.socket()},bind:function(t){if(t!=this.__socket){this.unbind(),this.__socket=t;var e=this;t.on("disconnect",function(){e.unbind()}),this.__active_session.trigger("bind_socket",t)}},unbind:function(){this.__socket=null,this.__active_session.activity(),this.__active_session.trigger("unbind_socket")},socket:function(){return this.__socket}}),BetaJS.Class.extend("BetaJS.Databases.Database",[BetaJS.SyncAsync.SyncAsyncMixin,{_tableClass:function(){return null},getTable:function(t){var e=this._tableClass();return new e(this,t)}}]),BetaJS.Class.extend("BetaJS.Databases.DatabaseTable",[BetaJS.SyncAsync.SyncAsyncMixin,{constructor:function(t,e){this._inherited(BetaJS.Databases.DatabaseTable,"constructor"),this._database=t,this._table_name=e},supportsSync:function(){return this._database.supportsSync()},supportsAsync:function(){return this._database.supportsAsync()},findOne:function(t,e,i){return this.then(this._findOne,[this._encode(t),e],i,function(t,e){BetaJS.SyncAsync.callback(e,"success",t?this._decode(t):null)})},_findOne:function(t,e,i){return e=e||{},e.limit=1,this.then(this._find,[t,e],i,function(t,e){BetaJS.SyncAsync.callback(e,"success",t.next())})},_encode:function(t){return t},_decode:function(t){return t},_find:function(){},find:function(t,e,i){return this.then(this._find,[this._encode(t),e],i,function(t,e){BetaJS.SyncAsync.callback(e,"success",new BetaJS.Iterators.MappedIterator(t,this._decode,this))})},findById:function(t,e){return this.findOne({id:t},{},e)},_insertRow:function(){},_removeRow:function(){},_updateRow:function(){},insertRow:function(t,e){return this.then(this._insertRow,[this._encode(t)],e,function(t,e){BetaJS.SyncAsync.callback(e,"success",this._decode(t))})},removeRow:function(t,e){return this._removeRow(this._encode(t),e)},updateRow:function(t,e,i){return this.then(this._updateRow,[this._encode(t),this._encode(e)],i,function(t,e){BetaJS.SyncAsync.callback(e,"success",this._decode(t))})},removeById:function(t,e){return this.removeRow({id:t},e)},updateById:function(t,e,i){return this.updateRow({id:t},e,i)},ensureIndex:function(){}}]),BetaJS.Databases.Database.extend("BetaJS.Databases.MongoDatabase",{constructor:function(t,e){BetaJS.Types.is_string(t)?(this.__dbUri=BetaJS.Strings.strip_start(t,"mongodb://"),this.__dbObject=this.cls.uriToObject(t)):(t=BetaJS.Objs.extend({database:"database",server:"localhost",port:27017},t),this.__dbObject=t,this.__dbUri=this.cls.objectToUri(t)),this._inherited(BetaJS.Databases.MongoDatabase,"constructor"),e=e||{},this._supportsAsync="async"in e?e.async:!1,this._supportsSync="sync"in e?e.sync:!this.__supportsAsync},_tableClass:function(){return BetaJS.Databases.MongoDatabaseTable},mongo_module_sync:function(){return this.__mongo_module_sync||(this.__mongo_module_sync=require("mongo-sync")),this.__mongo_module_sync},mongo_module_async:function(){return this.__mongo_module_async||(this.__mongo_module_async=require("mongodb")),this.__mongo_module_async},mongo_object_id:function(){return this.supportsSync()?this.mongo_module_sync().ObjectId:this.mongo_module_async().BSONNative.ObjectID},mongodb_sync:function(t){return this.eitherSyncFactory("__mongodb_sync",t,function(){var t=this.mongo_module_sync();this.__mongo_server_sync=new t.Server(this.__dbObject.server+":"+this.__dbObject.port);var e=this.__mongo_server_sync.db(this.__dbObject.database);return this.__dbObject.username&&e.auth(this.__dbObject.username,this.__dbObject.password),e})},mongodb_async:function(t){return this.eitherAsyncFactory("__mongodb_async",t,function(t){var e=this.mongo_module_async().MongoClient;e.connect("mongodb://"+this.__dbUri,{server:{auto_reconnect:!0}},BetaJS.SyncAsync.toCallbackType(t,BetaJS.SyncAsync.ASYNCSINGLE))})},destroy:function(){this.__mongo_server_sync&&this.__mongo_server_sync.close(),this.__mongo_server_async&&this.__mongo_server_async.close(),this._inherited(BetaJS.Databases.MongoDatabase,"destroy")}},{uriToObject:function(t){var e=BetaJS.Net.Uri.parse(t);return{database:BetaJS.Strings.strip_start(e.path,"/"),server:e.host,port:e.port,username:e.user,password:e.password}},objectToUri:function(t){return t.path=t.database,BetaJS.Net.Uri.build(t)}}),BetaJS.Databases.DatabaseTable.extend("BetaJS.Databases.MongoDatabaseTable",{constructor:function(t,e){this._inherited(BetaJS.Databases.MongoDatabaseTable,"constructor",t,e)},table_sync:function(t){return this.eitherSyncFactory("__table_sync",t,function(){return this._database.mongodb_sync().getCollection(this._table_name)})},table_async:function(t){var e=this;return this.eitherAsyncFactory("__table_async",t,function(){this._database.mongodb_async(BetaJS.SyncAsync.mapSuccess(t,function(i){BetaJS.SyncAsync.callback(t,"success",i.collection(e._table_name))}))})},table:function(t){return this.either(t,this.table_sync,this.table_async)},_encode:function(t){var e=BetaJS.Objs.clone(t,1);if("id"in t){delete e.id;var i=this._database.mongo_object_id();e._id=new i(t.id)}return e},_decode:function(t){var e=BetaJS.Objs.clone(t,1);return"_id"in t&&(delete e._id,e.id=t._id),e},_find:function(t,e,i){return this.then(this.table,i,function(i,s){this.thenSingle(i,i.find,[t],s,function(t,i){e=e||{},"sort"in e&&(t=t.sort(e.sort)),"skip"in e&&(t=t.skip(e.skip)),"limit"in e&&(t=t.limit(e.limit)),this.thenSingle(t,t.toArray,i,function(t,e){BetaJS.SyncAsync.callback(e,"success",new BetaJS.Iterators.ArrayIterator(t))})})})},_insertRow:function(t,e){return this.then(this.table,e,function(e,i){this.thenSingle(e,e.insert,[t],i,function(t,e){BetaJS.SyncAsync.callback(e,"success",t[0]?t[0]:t)})})},_removeRow:function(t,e){return this.then(this.table,e,function(e,i){this.thenSingle(e,e.remove,[t],i)})},_updateRow:function(t,e,i){return this.then(this.table,i,function(i,s){this.thenSingle(i,i.update,[t,{$set:e}],s,function(t,i){BetaJS.SyncAsync.callback(i,"success",e)})})},ensureIndex:function(t){var e={};e[t]=1,this.table({success:function(t){t.ensureIndex(e,function(){})}})}}),BetaJS.Stores.BaseStore.extend("BetaJS.Stores.DatabaseStore",{constructor:function(t,e,i){this._inherited(BetaJS.Stores.DatabaseStore,"constructor"),this.__database=t,this.__table_name=e,this.__table=null,this.__foreign_id=i},table:function(){return this.__table||(this.__table=this.__database.getTable(this.__table_name)),this.__table},_insert:function(t,e){if(!this.__foreign_id||!t[this.__foreign_id])return this.table().insertRow(t,e);var i={};return i[this.__foreign_id]=t[this.__foreign_id],this.table().findOne(i,{},{context:this,success:function(i){return i?BetaJS.SyncAsync.callback(e,"success",i):this.table().insertRow(t,e)},exception:function(t){BetaJS.SyncAsync.callback(e,"exception",t)}})},_remove:function(t,e){if(!this.__foreign_id)return this.table().removeById(t,e);var i={};return i[this.__foreign_id]=t,this.table().removeRow(i,e)},_get:function(t,e){if(!this.__foreign_id)return this.table().findById(t,e);var i={};return i[this.__foreign_id]=t,this.table().findOne(i,{},e)},_update:function(t,e,i){if(!this.__foreign_id)return this.table().updateById(t,e,i);var s={};return s[this.__foreign_id]=t,this.updateRow(s,e,i)},_query_capabilities:function(){return{query:!0,sort:!0,skip:!0,limit:!0}},_query:function(t,e,i){return this.table().find(t,e,i)},_ensure_index:function(t){this.table().ensureIndex(t)}}),BetaJS.Stores.ConversionStore.extend("BetaJS.Stores.MongoDatabaseStore",{constructor:function(t,e,i,s){var n=new BetaJS.Stores.DatabaseStore(t,e,s),r={},o={};i=i||{};var a=t.mongo_object_id();s||(i.id="id");for(var _ in i)"id"==i[_]&&(r[_]=function(t){return t?new a(t):null},o[_]=function(t){return t?t+"":null});var c={value_encoding:r,value_decoding:o};s&&(c.key_encoding={id:s},c.key_encoding[s]=null,c.key_decoding={id:null},c.key_encoding[s]="id"),this._inherited(BetaJS.Stores.MongoDatabaseStore,"constructor",n,c)}}),BetaJS.Class.extend("BetaJS.Stores.Migrator",{constructor:function(){this._inherited(BetaJS.Stores.Migrator,"constructor"),this.__version=null,this.__migrations=[],this.__sorted=!0},version:function(){return this.__version||(this.__version=this._getVersion()),this.__version},_getVersion:function(){},_setVersion:function(){},_log:function(){},migrations:function(){return this.__sorted||(this.__migrations.sort(function(t,e){return t.version-e.version}),this.__sorted=!0),this.__migrations},register:function(t){this.__migrations.push(t),this.__sorted=!1},_indexByVersion:function(t){for(var e=0;this.__migrations.length>e;++e){if(t==this.__migrations[e].version)return e;if(this.__migrations[e].version>t)return e-1}return this.__migrations.length},migrate:function(t){for(var e=this._indexByVersion(this.version()),i=BetaJS.Types.is_defined(t)?this._indexByVersion(t):this.__migrations.length-1;i>e;){var s=this.__migrations[e+1];this._log("Migrate "+s.version+": "+s.title+" - "+s.description+"...\n");try{s.migrate(),this._setVersion(this.__migrations[e+1].version),e++,this._log("Successfully migrated "+s.version+".\n")}catch(n){this._log("Failure! Rolling back "+s.version+"...\n");try{s.partial_rollback()}catch(n){throw this._log("Failure! Couldn't roll back "+s.version+"!\n"),n}throw this._log("Rolled back "+s.version+"!\n"),n}}},rollback:function(t){for(var e=this._indexByVersion(this.version()),i=BetaJS.Types.is_defined(t)?this._indexByVersion(i):-1;e>i;){var s=this.__migrations[e];this._log("Rollback "+s.version+": "+s.title+" - "+s.description+"...\n");try{s.rollback(),this._setVersion(e>=1?this.__migrations[e-1].version:0),e--,this._log("Successfully rolled back "+s.version+".\n")}catch(n){throw this._log("Failure! Couldn't roll back "+s.version+"!\n"),n}}}}),BetaJS.Stores.BaseStore.extend("BetaJS.Stores.ImapStore",{constructor:function(t){this._inherited(BetaJS.Stores.ImapStore,"constructor",t),this._supportSync=!1,this.__imap=BetaJS.Objs.extend(BetaJS.Objs.clone(t.base,1),t.imap),this.__smtp=BetaJS.Objs.extend(BetaJS.Objs.clone(t.base,1),t.smtp),this.__imap_opts=t.imap_options||{},this.__imap_opts.reconnect_on_error=!1},test:function(t){var e=new BetaJS.Server.Net.Imap(this.__imap,this.__imap_opts);e.connect({success:function(){e.destroy(),BetaJS.SyncAsync.callback(t,"success")},exception:function(){e.destroy(),BetaJS.SyncAsync.callback(t,"exception")}})},_query_capabilities:function(){return{skip:!0,limit:!0}},_query:function(t,e,i){var s=this,n=new BetaJS.Server.Net.Imap(this.__imap,this.__imap_opts);n.connect(BetaJS.SyncAsync.mapSuccess(i,function(){var t={};"skip"in e&&(t.seq_start=e.skip+1),"limit"in e&&(t.seq_count=e.limit),t.reverse=!0,n.fetch(t,BetaJS.SyncAsync.mapSuccess(i,function(t){s.callback(i,"success",BetaJS.Objs.map(t,function(t){return t})),n.destroy()}))}))},_insert:function(t,e){BetaJS.Server.Net.Smtp.send(this.__smtp,{from:t.from,to:t.to,subject:t.subject,text_body:t.text_body},{context:e.context,success:function(i){t.id=i.header["message-id"],BetaJS.SyncAsync.callback(e,"success",t)},exception:function(t){BetaJS.SyncAsync.callback(e,"exception",new BetaJS.Stores.StoreException(t))}})}}),BetaJS.Stores.ListenerStore.extend("BetaJS.Stores.ImapListenerStore",{constructor:function(t){this._inherited(BetaJS.Stores.ImapListenerStore,"constructor",t);var e=BetaJS.Objs.extend(BetaJS.Objs.clone(t.base,1),t.imap),i=new BetaJS.Server.Net.Imap(e,{reonnect_on_error:!0});this._auto_destroy(i),i.on("new_mail",function(t){i.fetch({seq_count:t,reverse:!0},{context:this,success:function(t){BetaJS.Objs.iter(t,function(t){this._inserted(t)},this)}})},this),i.connect()}});