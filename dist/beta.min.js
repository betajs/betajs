...
this._renderItem(a,b,!1)}},_addItem:function(a,b,c){this._renderItem(a,b,c)},_renderItem:function(a,b){null!=this.templates("item")?b.html(this.evaluateTemplate("item",{item:a})):null!=this.dynamics("item")?this.evaluateDynamics("item",b,{item:a},{name:"item-"+BetaJS.Ids.objectId(a)}):b.html(a.get(this.__item_label))},_removeItem:function(a){null!=this.dynamics("item")&&this.dynamics("item").removeInstanceByName("item-"+BetaJS.Ids.objectId(a))}}),BetaJS.Views.SubViewListView=BetaJS.Views.CustomListView.extend("SubViewListView",{constructor:function(a){this._inherited(BetaJS.Views.SubViewListView,"constructor",a),"create_view"in a&&(this._create_view=a.create_view),this._setOption(a,"sub_view",BetaJS.Views.LabelView),this._setOption(a,"item_label","label");var b=this;this._setOption(a,"sub_view_options",function(a){return{label:a.binding(b.__item_label)}})},_create_view:function(a,b){var c=this.__sub_view_options(a);return c.el=b,new this.__sub_view(c)},_addItem:function(a,b){var c=this._create_view(a,b);this.itemData(a).view=c,this.addChild(c)},_destroyItemData:function(a){this.removeChild(a.view),a.view.destroy()}});